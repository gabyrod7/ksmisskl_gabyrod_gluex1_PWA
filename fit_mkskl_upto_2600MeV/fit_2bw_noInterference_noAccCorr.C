...
void fit_2bw_noInterference_noAccCorr() {
	gStyle->SetOptStat(0);
	...
	TFile *inf = TFile::Open("hists/hist_dat_sp17.root");
	TH1F *h_sp17 = (TH1F*)inf->Get("im_kskl");

	TFile *inf2 = TFile::Open("hists/hist_dat_sp18.root");
	TH1F *h_sp18 = (TH1F*)inf2->Get("im_kskl");

	TFile *inf3 = TFile::Open("hists/hist_dat_fa18.root");
	TH1F *h_fa18 = (TH1F*)inf3->Get("im_kskl");
	...
	c->SaveAs("pdf_nInterference/noAcceptanceCorrection.pdf");
	...
	TFile *outf = new TFile("rootFiles/fit_noAcceptanceCorrection.root", "RECREATE");
	m1->Write("m1");
	m2->Write("m2");
	g1->Write("g1");
	g2->Write("g2");
