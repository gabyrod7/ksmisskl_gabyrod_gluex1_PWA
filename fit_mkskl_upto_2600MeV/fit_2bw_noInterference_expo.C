...
void fit_2bw_noInterference_expo() {
	gStyle->SetOptStat(0);
	...
	fit->SetParameters(10, 1.50, 0.20, 10, 1.78, 0.12, 2.98037e+04, -4.95352e-01);
	...
	TFile *outf = new TFile("rootFiles/fit_expo.root", "RECREATE");
	m1->Write("m1");
	m2->Write("m2");
	g1->Write("g1");
	g2->Write("g2");
