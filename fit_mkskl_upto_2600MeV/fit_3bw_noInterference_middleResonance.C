...
void fit_3bw_noInterference_middleResonance() {
	gStyle->SetOptStat(0);
	...
	fit->SetParameters(100, 1.54, 0.25, 100, 1.75, 0.12, 100, 1.9, 0.4);
	// fit->FixParameter(1, 1.538);
	// fit->FixParameter(2, 0.257);
	fit->SetParLimits(0, 0, 10000000);
	fit->SetParLimits(3, 0, 10000000);
	fit->SetParLimits(6, 0, 10000000);
	fit->FixParameter(4, 1.680);
	fit->FixParameter(5, 0.150);
	fit->SetParLimits(7, 1.2, 2);
	...
	c->SaveAs("pdf_nInterference/3bw_noInterference_middleResonance.pdf");
