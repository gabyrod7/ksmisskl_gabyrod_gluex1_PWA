...
void fit_wInterference_changeRange() {
	gStyle->SetOptStat(0);
	...
	pars = fit_2bw_with_interference(hName, 1.14, 2.66, "fit_range1");
	...
	phase->SetPoint(0, 0, pars[8]);
	phase->SetPointError(0, 0, pars[9]);


	hName = "im_kskl_fitRange2";
	// pars = fit_2bw_no_interference(hName, 1.20, 2.54, "fit_range2");
	pars = fit_2bw_with_interference(hName, 1.20, 2.54, "fit_range2");
	...
	phase->SetPoint(1, 1, pars[8]);
	phase->SetPointError(1, 0, pars[9]);

	hName = "im_kskl_fitRange3";
	// pars = fit_2bw_no_interference(hName, 1.16, 2.5, "fit_range3");
	pars = fit_2bw_with_interference(hName, 1.16, 2.5, "fit_range3");
	...
	phase->SetPoint(2, 2, pars[8]);
	phase->SetPointError(2, 0, pars[9]);

	hName = "im_kskl_fitRange4";
	// pars = fit_2bw_no_interference(hName, 1.16, 2.7, "fit_range4");
	pars = fit_2bw_with_interference(hName, 1.16, 2.7, "fit_range4");
	...
	phase->SetPoint(3, 3, pars[8]);
	phase->SetPointError(3, 0, pars[9]);

	// fit_2bw_with_interference(hName, 1.20, 2.54, "fit_range2");

	TFile *opf = TFile::Open("rootFiles/fit_wInterference_changeRange.root", "RECREATE");
	m1->Write("m1");
	m2->Write("m2");
	g1->Write("g1");
	g2->Write("g2");
